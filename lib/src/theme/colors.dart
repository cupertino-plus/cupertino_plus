...
/// {@template cupertinew_colors}
/// A class that holds color data for Cupertinew themes.
///
/// Default [CupertinewColors.light] and [CupertinewColors.dark] themes are
/// provided, and both follow the Apple design guidelines. Themes can be
/// customized creating a custom [CupertinewColors] or by using [copyWith] to
...
/// * [CupertinewTheme], which is a widget used to provide Cupertinew theme data
///   to the rest of the application, analogous to [Theme].
/// {@endtemplate}
class CupertinewColors extends Equatable {
  /// {@macro cupertinew_colors}
  const CupertinewColors({
  ...
  /// Creates a light [CupertinewColors] theme with default values.
  const CupertinewColors.light({
  ...
  /// Creates a dark [CupertinewColors] theme with default values.
  const CupertinewColors.dark({
  ...
  /// Looks up the nearest [CupertinewTheme] in the given [BuildContext] and
  /// returns its colors.
  ///
  /// If no [CupertinewTheme] can be found, this throws a [FlutterError].
  static CupertinewColors of(BuildContext context) {
    return CupertinewTheme.of(context).colors;
  }

  /// Looks up the nearest [CupertinewTheme] in the given [BuildContext] and
  /// returns its colors.
  ///
  /// If no [CupertinewTheme] can be found, this returns `null`.
  static CupertinewColors? maybeOf(BuildContext context) {
    return CupertinewTheme.maybeOf(context)?.colors;
  }

  /// Creates a copy of this theme with the given fields replaced with the new
  /// values.
  CupertinewColors copyWith({
