...
/// {@template cupertinew_list_tile}
/// A quick, dirty and eye-balled version of the iOS list tile.
/// Do not use this.
///
/// TODO(@jeroen-meijer): Add documentation.
/// {@endtemplate}
class CupertinewListTile extends StatefulWidget {
  /// {@macro cupertinew_list_tile}
  const CupertinewListTile({
    Key? key,
  ...
  @override
  _CupertinewListTileState createState() => _CupertinewListTileState();
}

class _CupertinewListTileState extends State<CupertinewListTile>
